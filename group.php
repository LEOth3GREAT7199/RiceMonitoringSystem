...
<body class = "alert-warning">
	...
	<div class = "container-fluid">
		<ul class="nav nav-pills">
			...
			<li class="active"><a href="club.php">Inventory</a></li>
		</ul>
		<br />
		<div class = "col-md-12 well">
			<button type = "button" class = "btn btn-success"  data-toggle="modal" data-target="#myModal"><span class = "glyphicon glyphicon-plus"></span> Add crops</button>
			...
			?>
				<div class = "alert alert-success"><?php echo $c_fetch['club_name']?> / Crops List</div>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Inventory Registration</h4>
			</div>
